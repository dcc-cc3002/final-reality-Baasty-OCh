...
abstract class AMagicPlayable(name: String, healthPoints: Int,
   ...
   */
  override def hasSpell(): Option[Spell] = this.spell
   ...
   * @return The integer 0 indicating the entity is common.
   */
   ...
   * @return "It is Enough" if sufficient mana is available.
   ...
   * @return "Yes" if a magic weapon is equipped.
